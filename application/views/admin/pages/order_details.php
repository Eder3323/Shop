                    ...
                    <tbody>
                        ...
                        foreach ($order_details_info as $single_order_details) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->cart->format_number($single_order_details->product_price)?> MXN</td>
                                <td><?php echo $single_order_details->product_sales_quantity ?></td>
                                <td><?php echo $this->cart->format_number($single_order_details->product_price * $single_order_details->product_sales_quantity) ?> MXN</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                    <tfooter>
                        <td colspan="5">Total Amount</td>
                        <td>= <?php echo $this->cart->format_number($order_info->order_total)?> MXN</td>
                    </tfooter>
                </table>
            </div>
        </div><!--/span-->
